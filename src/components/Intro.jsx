...
const Intro = () => {
  return (
    <div className={` bg-none w-full pt-[50px] mx-auto flex flex-row justify-center items-center pr-[100px] pl-[100px] gap-5`}>
        ...
        <div className="flex flex-col justify-center items-center mt-5">
           <div className="w-[270px] h-[270px] rounded-full bg-[#fff] flex justify-center items-center">
            <img src={logo} className="w-[265px] h-[265px] rounded-full w-full object-cover shadow-card"/>
           </div>
